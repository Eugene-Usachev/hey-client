...
export const LoadingRightColumn = () => {
	return (
		<div style={{width: '635px', marginTop: '5px', display: 'flex', flexFlow: 'column', alignItems: 'center', marginBottom: '10px'}}>
			<div style={{display: 'flex', flexFlow: 'column', width: '635px', borderBottom: '1px solid var(--colors-hover)', padding: '15px 15px 15px 0', marginLeft: '15px'}}>
