...
class LogGroup {
    ...
    newStep(this: LogGroup, elem: {name: string}) {
        this.steps.set(elem.name, newLogGroupStep(this.eye, elem, this.name));
    };

    ready(this: LogGroup, key: string, finish: boolean): boolean {
...
export class Eye {
    ...
    newLogGroup(this: Eye, key: string, firstElem: {name: string}, message?: string) {
    ...
    stepReady(this: Eye, key: string, stepName: string, finish = false) {
     ...
     * styled log message
     * */
    enter(this: Eye, message: any, isTimeNecessary = true, style: string[] = []) {
     ...
     * log warn
     * */
    warn(this: Eye, message: any, isTimeNecessary = true) {
     ...
     * log error
     * */
    error(this: Eye, message: any, isTimeNecessary = true) {
     ...
     * log info
     * */
    info(this: Eye, message: any, isTimeNecessary = true) {
     ...
     * log success
     * */
    success(this: Eye, message: any, isTimeNecessary = true) {
     ...
     * log ready
     * */
    ready(this: Eye, message: any, isTimeNecessary = true) {
     ...
     * */
    log(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true, type: string = "log", style: string[] = []) {
        const realStyle = this.baseStyle.join(';') + ';' + style.join(';') + ';';
     ...
     * log date, type and object. It can be used to log object or array.
     * */
    logWarn(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true) {
     ...
     * log date, type and object. It can be used to log object or array.
     * */
    logError(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true) {
     ...
     * log date, type and object. It can be used to log object or array.
     * */
    logInfo(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true) {
     ...
     * log date, type and object. It can be used to log object or array.
     * */
    logSuccess(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true) {
     ...
     * log date, type and object. It can be used to log object or array.
     * */
    logReady(this: Eye, object: Object | any[] | Map<any, any> | Set<any>, isTimeNecessary = true) {
